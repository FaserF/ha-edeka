# AI Agent Reference for ha-edeka
...
| Area | Path |
|---|---|
| Integration Entry | `custom_components/edeka/__init__.py` |
| Coordinator | `custom_components/edeka/coordinator.py` |
| Config Flow | `custom_components/edeka/config_flow.py` |
| Sensor platform | `custom_components/edeka/sensor.py` |
