"""Test the EDEKA Discounts button platform."""
...
from custom_components.edeka.button import EdekaForceUpdateButton, async_setup_entry
...
async def test_button_setup(hass: HomeAssistant) -> None:
    ...
    assert isinstance(entities[0], EdekaForceUpdateButton)
...
async def test_button_disabled_by_default(hass: HomeAssistant) -> None:
    ...
    button = EdekaForceUpdateButton(coordinator)
